...
* [Public Pages](https://zatzlabs.com/project/my-private-site-public-pages/): Allows site operators to designate certain specific pages, or pages with specified prefix, to be available to the public without login. [Watch the video](https://youtu.be/9WwoF8snNHY)
